...
public class TheTopology {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String keywords[] = { "gameofthrones", "modibowstochina", "Italian Court", "AAPStabsPunjab", "Finance Ministry"};
        ...
        builder.setSpout("tweet-spout", twitterSpout, 2);
        builder.setBolt("wrangle-bolt", new WrangleBolt(), 2).shuffleGrouping("tweet-spout");
        //builder.setBolt("sentiment-bolt", new SentimentBolt(), 1).shuffleGrouping("wrangle-bolt");
        builder.setBolt("sentiment-bolt", new SentBoltPython(pythonFile), 2).shuffleGrouping("wrangle-bolt");
        //String outputBoltFile = Resources.getResource("output-bolt.py").toString().substring(5);
        builder.setBolt("output-bolt", new OutputBolt(), 2).shuffleGrouping("sentiment-bolt");
